...
-- Info
-- ---------------------------------------------------------------------------
instance (ToJSON v) => ToJSON (Syntax.NoInfo v) where
  toJSON Syntax.NoInfo = Null

instance (ToJSON v) => ToJSON (Syntax.Info v) where
  toJSON (Syntax.Info v) = toJSON v
...
instance
  ( ToJSON v,
    ToJSON (te v),
    forall x. (ToJSON x) => ToJSON (f x)
  ) =>
  ToJSON (Syntax.PatBase te f v)
  where
  toJSON (Syntax.PatId v t info _) =
    object ["tag" .= ("PatId" :: T.Text), "var" .= v, "type" .= t, "info" .= info]
...
instance
  ...
  ToJSON (Syntax.AtomBase te tp f v)
  where
  toJSON (Syntax.Base b info _) =
    object ["tag" .= ("Base" :: T.Text), "lit" .= b, "info" .= info]
  toJSON (Syntax.Lambda param body info _) =
    object ["tag" .= ("Lambda" :: T.Text), "param" .= param, "body" .= body, "info" .= info]
  toJSON (Syntax.TLambda param body info _) =
    object ["tag" .= ("TLambda" :: T.Text), "param" .= param, "body" .= body, "info" .= info]
  toJSON (Syntax.ILambda param body info _) =
    object ["tag" .= ("ILambda" :: T.Text), "param" .= param, "body" .= body, "info" .= info]
  toJSON (Syntax.Box ispace body t info _) =
    object ["tag" .= ("Box" :: T.Text), "ispace" .= ispace, "array" .= body, "type" .= t, "info" .= info]
...
instance
  ...
  toJSON (Syntax.BindFun v ps mt body info _) =
    object ["tag" .= ("BindFun" :: T.Text), "var" .= v, "params" .= ps, "type" .= mt, "expr" .= body, "info" .= info]
  toJSON (Syntax.BindTFun v ps mt body info _) =
    object ["tag" .= ("BindTFun" :: T.Text), "var" .= v, "params" .= ps, "type" .= mt, "expr" .= body, "info" .= info]
  toJSON (Syntax.BindIFun v ps mt body info _) =
    object ["tag" .= ("BindIFun" :: T.Text), "var" .= v, "params" .= ps, "type" .= mt, "expr" .= body, "info" .= info]
...
instance
  ...
  ToJSON (Syntax.ExpBase te tp f v)
  where
  toJSON (Syntax.Var v info _) =
    object ["tag" .= ("Var" :: T.Text), "name" .= v, "info" .= info]
  toJSON (Syntax.Array shape as info _) =
    object ["tag" .= ("Array" :: T.Text), "dims" .= shape, "atoms" .= as, "info" .= info]
  toJSON (Syntax.EmptyArray shape t info _) =
    object ["tag" .= ("EmptyArray" :: T.Text), "dims" .= shape, "type" .= t, "info" .= info]
  toJSON (Syntax.Frame shape es info _) =
    object ["tag" .= ("Frame" :: T.Text), "dims" .= shape, "exprs" .= es, "info" .= info]
  toJSON (Syntax.EmptyFrame shape t info _) =
    object ["tag" .= ("EmptyFrame" :: T.Text), "dims" .= shape, "type" .= t, "info" .= info]
  toJSON (Syntax.App f arg info _) =
    object ["tag" .= ("App" :: T.Text), "fun" .= f, "arg" .= arg, "info" .= info]
  toJSON (Syntax.TApp f t info _) =
    object ["tag" .= ("TApp" :: T.Text), "fun" .= f, "arg" .= t, "info" .= info]
  toJSON (Syntax.IApp f ispace info _) =
    object ["tag" .= ("IApp" :: T.Text), "fun" .= f, "arg" .= ispace, "info" .= info]
...
instance
  ...
  ToJSON (Syntax.DeclBase te tp f v)
  where
  toJSON (Syntax.Def bind) =
    object ["tag" .= ("Def" :: T.Text), "bind" .= bind]
  toJSON (Syntax.Entry v args mt body info _) =
    object ["tag" .= ("Entry" :: T.Text), "var" .= v, "params" .= args, "type" .= mt, "expr" .= body, "info" .= info]
...
instance
  ...
  ToJSON (Syntax.ProgBase te tp f v)
  where
